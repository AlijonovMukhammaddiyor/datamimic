...
export default function NewsSection() {
    ...
    return(
        ...
        <div className=''>
        <div className='uppercase text-[48px] leading-[56px] font-medium text-start text-[#FF1D00] '>News&Updates</div>
        ...
        <div className='flex font-sans flex-col justify-between space-y-5'>
            <div className='flex items-center justify-start text-[#FF1D00] space-x-4'>
                <img className='h-4 w-4' src='/images/icons/icon.png'/>
                <div>22 FEB 2024</div>
            </div>
        ...
        <div className='col-span-1'><img src='/images/prepare-img.png'/></div>
        </div>
        <div className='flex font-sans flex-col justify-between space-y-5'>
            <div className='flex items-center justify-start text-[#FF1D00] space-x-4'>
                <img className='h-4 w-4' src='/images/icons/icon.png'/>
            ...
            <div className='font-sans grid grid-cols-3'>
              <div className='col-span-2'>
                <div className='flex flex-col justify-between'>
                  ...
                  Jalaswap, a decentralized exchange, raises<br/> $23 million to develop sports token swaps
                  </div>
                </div>
              </div>
              <div className='col-span-1 pl-6'><img src='/images/prepare-img.png'/></div>
            </div>
            <div className='font-sans grid grid-cols-3'>
              <div className='col-span-2'>
                <div className='flex flex-col justify-between'>
