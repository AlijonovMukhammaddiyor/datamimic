  ...
  return (
    <div className="flex-col w-full">
      {isMobile ? (
        <div className=" px-[5%]">
          <div className="pb-3">
            <img src="/images/icons/globe-icon.svg"></img>
          </div>
          <div className="flex justify-start uppercase text-4xl font-medium text-[#FF1D00]">WHAT WE DO</div>
          <div className="flex flex-col items-start justify-evenly gap-y-10 py-10">
            ...
            <LaunchCard
              ...
              title={"LAUNCHPAD"}
              index={"002"}
              description={"Show your support for your top picks on Chiliz. Join the adventure and make a difference."}
            />
            <div className="border-b border-[#595959] w-full"></div>
            <LaunchCard
              isLaunched={false}
